...
import ComButton from '../Creat/ComButton';
...
export const Product = () => {
    ...
    return (loaded &&
        ...
        <div className="box"  >
            ...
            <ComButton ButtonHandler={deleteProduct} value="Delete" className='delAndUpd' />
            <ComButton ButtonHandler={editProduct} value="Edit" className='delAndUpd' />
